...
const STEPS:Record<Exclude<RenderStatus,'ready'|'failed'>,{status:RenderStatus;progress:number;stage:string;delay:number}>={accepted:{status:'composing',progress:26,stage:'Deterministic scene composition',delay:180},composing:{status:'encoding',progress:58,stage:'FFmpeg encode + subtitle burn-in',delay:240},encoding:{status:'packaging',progress:84,stage:'Artifact checksum + metadata',delay:220},packaging:{status:'ready',progress:100,stage:'Delivery-ready artifact',delay:180}};
