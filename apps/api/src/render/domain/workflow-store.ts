...
export type CreateWorkflow = { tenantId:string; traceId:string; command:CreateRenderJob; quotaTokens:number };
export type ClaimedWork = { id:string; jobId:string; tenantId:string; workerId:string; attempt:number };
...
export interface WorkflowStore {
  ...
  advance(work:ClaimedWork,status:RenderStatus,progress:number,stage:string): Promise<RenderJob|undefined>;
