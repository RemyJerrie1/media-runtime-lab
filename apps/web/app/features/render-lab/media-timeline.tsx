...
export function MediaTimeline() {
  ...
  useEffect(() => {
    ...
    const draw = (elapsedMs: number) => {
      ...
      ctx.fillStyle = '#f3e9df'; ctx.font = '600 26px system-ui'; ctx.fillText('確定性媒體合成時間軸', 38, 48);
      ...
      ctx.fillText(`18.0 秒 · 每秒 30 影格 · 影格 ${String(currentFrame).padStart(3, '0')} · ${currentSecond.toFixed(1)} 秒`, 38, 75);
      ...
      ctx.fillStyle = '#9eacba'; ctx.fillText('場景', 20, 126); ctx.fillText('字幕', 20, 181); ctx.fillText('音訊', 20, 236);
