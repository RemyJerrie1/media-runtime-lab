  ...
  it('keeps edit, encoding, trace, artifact and usage evidence on every receipt', () =>
    expect(
      renderJobSchema.safeParse({
        ...
        ffmpegArgs: ['-crf', '23'],
        artifactUrl: '/artifacts/00000000-0000-4000-8000-000000000002.mp4',
        artifactChecksum: 'sha256:abc',
        manifestUrl: '/streams/00000000-0000-4000-8000-000000000002/master.m3u8',
        renditions: [
          {
            id: '720p',
            width: 1280,
            height: 720,
            bitrateKbps: 2500,
            playlistUrl: '/streams/00000000-0000-4000-8000-000000000002/720p.m3u8',
            checksum: 'sha256:def',
            vmaf: 94.2,
